...
class ProdutoService {
    ...
    async createProduto({ nome, valor, quantidade }) {
        ...
        return { mensagem: "erro ao criar produto", data: [], status: false }
    }
    ...
    async comprar(id,quantidade) {
        ...
        if (quantidadeNumber <=0) {
            ...
            return {mensagem: "Quantidade tem que ser maior que zero", data: [], status: false}
            ...
            if (estoque.data?.quantidade >= quantidadeNumber) {
                ...
                if (productrModify.rowCount === 1) {
                    ...
                    return { mensagem: "Compra efetuada", data: productrModify.rows[0], status: true }

                }
            }


            return { mensagem: "erro ao comprar", data: [], status: false }
